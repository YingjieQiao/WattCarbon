      ...
      <nav class="fixed top-0 w-screen flex flex-row p-1">
        ...
        <div class="ml-auto items-center">
          {currentAccount && !chainErr ? (
            <div class="bg-white p-2 rounded-full flex flex-row space-x-2 drop-shadow">
              <div class="bg-green-400 rounded-full w-4 h-4 self-center" />
            ...
            <div class="bg-white p-2 rounded-full flex flex-row space-x-2 drop-shadow">
              <div class="bg-red-400 rounded-full w-4 h-4 self-center" />
        ...
        <div>
          {currPendingTxNum > 0 && !chainErr ? (
            <div class="bg-white p-2 rounded-full flex flex-row space-x-2 drop-shadow">
              <svg role="status" class="mr-2 w-4 h-4 text-white animate-spin fill-blue-600 self-center" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg" >
              ...
              <span>{currPendingTxNum} pending transactions</span>
            </div>
          ) : (
            <div class="bg-white p-2 rounded-full flex flex-row space-x-2 drop-shadow">
              <div class="bg-blue-400 rounded-full w-4 h-4 self-center" />
